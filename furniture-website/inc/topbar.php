   ...
   <!-- add bar with social media icons and login/signup/logout buttons -->
            ...
            <div class="col-md-6">
              <div class="d-flex justify-content-md-end justify-content-between">
                ...
                <ul class="list-inline mb-0">
                  ...
                  <li class="list-inline-item"><a class="text-xs text-uppercase fw-bold text-reset" href="customer-register.php"><i class="fas fa-user me-2"></i><span class="d-none d-md-inline-block">Sign Up</span></a></li>
                </ul>
                <?php  }else{ ?>
                <ul class="list-inline mb-0">
                  <li class="list-inline-item"><a class="text-xs text-uppercase fw-bold text-reset" href="logout.php"><i class="fas fa-door-open me-2"></i><span class="d-none d-md-inline-block">Log out</span></a></li>
                </ul>
                <?php } ?>
