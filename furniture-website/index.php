...
<html>
  ...
  <body>
    <div class="wide" id="all">
      ...
      <!-- HERO SLIDER SECTION-->
      <section class="text-white bg-cover bg-center primary-overlay overlay-dense" style="background: url('assets/img/photogrid.jpg') repeat">
                ...
                <div class="swiper-slide h-auto mb-5">
                  <div class="row gy-5 h-100 align-items-center">
                    <div class="col-lg-5 text-lg-end">
                      <!-- <img class="ml-auto img-fluid" src="assets/img/logo.png" alt=""> -->
                      <h1 class="text-uppercase">Ultra Flat-pack Concept.</h1>
                      <ul class="list-unstyled text-uppercase fw-bold mb-0">
                        <li class="mb-2">This is the future of furniture</li>
                        <li>Environment-friendly. Low coast & Fast shipping</li>
                      </ul>
                    </div>
                    <div class="col-lg-7"><img class="img-fluid" src="assets/img/Mood_pictures/2.jpg" alt=""></div>
                  </div>
                </div>
                <!-- Hero Slide-->
                <div class="swiper-slide h-auto mb-5">
                  <div class="row gy-5 h-100 align-items-center">
                    <div class="col-lg-7"><img class="img-fluid" src="assets/img/Mood_pictures/_MG_6435.jpg" alt=""></div>
                    <div class="col-lg-5">
                      <h1 class="text-uppercase">A universe of unique designs.</h1>
                      <ul class="list-unstyled text-uppercase fw-bold mb-0">
                        <li class="mb-2">Principles from the mathematics and the nature itself</li>
                ...
                <div class="swiper-slide h-auto mb-5">
                  <div class="row gy-5 h-100 align-items-center">
                    <div class="col-lg-5 text-lg-end">
                      ...
                      <ul class="list-unstyled text-uppercase fw-bold mb-0">
                        <li class="mb-2">Chairs</li>
                        <li class="mb-2">Tables</li>
                        <li class="mb-2">Accessories</li>
                        <li>Storages</li>
                      </ul>
                    </div>
                    <div class="col-md-7"><img class="img-fluid" src="assets/img/Mood_pictures/_MG_6452.jpg" alt=""></div>
                  </div>
                </div>
                <!-- Hero Slide-->
                <div class="swiper-slide h-auto mb-5">
                  <div class="row gy-5 h-100 align-items-center">
                    <div class="col-lg-7"><img class="img-fluid" src="assets/img/Mood_pictures/_MG_6478.jpg" alt=""></div>
                    <div class="col-lg-5">
                      <h1 class="text-uppercase">Our series</h1>
                      <ul class="list-unstyled text-uppercase fw-bold mb-0">
                        <li>Arch</li>
                        <li>Android</li>
                        <li>Frame</li>
      ...
      <!-- BANNER SECTION-->
      <section class="py-5 bg-fixed bg-cover bg-center dark-overlay" style="background: url(assets/img/fixed-background-2.jpg)">
        <div class="overlay-content">
          <div class="container py-4 text-white text-center">
            ...
            <p class="lead mb-4">We have prepared for you more than 40 different HTML pages, including 5 variations of homepage.</p><a class="btn btn-outline-light btn-lg" href="#">See another homepage</a>
          </div>
        </div>
      </section>
      <!-- BLOG SECTION-->
        ...
        <div class="container py-4">
          ...
          <div class="row gy-5">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="box-image">
                <div class="mb-4 primary-overlay"><img class="img-fluid" src="assets/img/portfolio-1.jpg" alt="...">
                  <div class="overlay-content d-flex flex-column justify-content-center p-4">
                    <ul class="list-inline mb-0 box-image-content text-center">
                      <li class="list-inline-item"><a class="btn btn-outline-light" href="#"> <i class="fas fa-link me-2"></i>Read more</a></li>
                    </ul>
                  </div>
                </div>
                <div class="text-center">                   
                  <h3 class="h4 text-uppercase text-primary"> <a class="text-reset" href="#">Fashion now </a></h3>
                  <p class="small text-uppercase text-muted">By <a href="#">John snow </a>in <a href="#">Web design</a></p>
                  <p class="text-gray-600 text-sm text-start">Fifth abundantly made Give sixth hath. Cattle creature i be don't them behold green moved fowl Moved life us beast good yielding. Have bring.</p><a class="btn btn-outline-primary" href="#">Continue reading</a>
                </div>
              </div>
            </div>
            <!-- blog box-->
            <div class="col-lg-3 col-md-6">
              <div class="box-image">
                <div class="mb-4 primary-overlay"><img class="img-fluid" src="assets/img/portfolio-2.jpg" alt="...">
                  <div class="overlay-content d-flex flex-column justify-content-center p-4">
                    <ul class="list-inline mb-0 box-image-content text-center">
                      <li class="list-inline-item"><a class="btn btn-outline-light" href="#"> <i class="fas fa-link me-2"></i>Read more</a></li>
                    </ul>
                ...
                <div class="text-center">                   
                  <h3 class="h4 text-uppercase text-primary"> <a class="text-reset" href="#">What to do </a></h3>
                  <p class="small text-uppercase text-muted">By <a href="#">John snow </a>in <a href="#">Web design</a></p>
                  <p class="text-gray-600 text-sm text-start">Fifth abundantly made Give sixth hath. Cattle creature i be don't them behold green moved fowl Moved life us beast good yielding. Have bring.</p><a class="btn btn-outline-primary" href="#">Continue reading</a>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="box-image">
                <div class="mb-4 primary-overlay"><img class="img-fluid" src="assets/img/portfolio-3.jpg" alt="...">
                  <div class="overlay-content d-flex flex-column justify-content-center p-4">
                    <ul class="list-inline mb-0 box-image-content text-center">
                      <li class="list-inline-item"><a class="btn btn-outline-light" href="#"> <i class="fas fa-link me-2"></i>Read more</a></li>
                    </ul>
                ...
                <div class="text-center">                   
                  <h3 class="h4 text-uppercase text-primary"> <a class="text-reset" href="#">5 ways to look awesome </a></h3>
                  <p class="small text-uppercase text-muted">By <a href="#">John snow </a>in <a href="#">Web design</a></p>
                  <p class="text-gray-600 text-sm text-start">Fifth abundantly made Give sixth hath. Cattle creature i be don't them behold green moved fowl Moved life us beast good yielding. Have bring.</p><a class="btn btn-outline-primary" href="#">Continue reading</a>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="box-image">
                <div class="mb-4 primary-overlay"><img class="img-fluid" src="assets/img/portfolio-4.jpg" alt="...">
                  <div class="overlay-content d-flex flex-column justify-content-center p-4">
                    <ul class="list-inline mb-0 box-image-content text-center">
                      <li class="list-inline-item"><a class="btn btn-outline-light" href="#"> <i class="fas fa-link me-2"></i>Read more</a></li>
                    </ul>
                ...
                <div class="text-center">                   
                  <h3 class="h4 text-uppercase text-primary"> <a class="text-reset" href="#">Fashion snow </a></h3>
                  <p class="small text-uppercase text-muted">By <a href="#">John snow </a>in <a href="#">Web design</a></p>
                  <p class="text-gray-600 text-sm text-start">Fifth abundantly made Give sixth hath. Cattle creature i be don't them behold green moved fowl Moved life us beast good yielding. Have bring.</p><a class="btn btn-outline-primary" href="#">Continue reading</a>
                </div>
              </div>
